...
# Create tables
db.execute("CREATE TABLE places (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT NOT NULL, destination TEXT NOT NULL, url TEXT, email TEXT, phone TEXT, description TEXT, public BOOLEAN, 'timestamp' TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL)")
